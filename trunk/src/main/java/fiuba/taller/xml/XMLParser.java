...
/* TODO: Encapsular el agregado de tags de cierre de XML en metodo aparte y 
 * el agregado de info de cada clase en metodos apartes!
 */
public class XMLParser {
	...
	/**
	 * Descerializa un xml
	 * @param xml a descerializar
	 * @return string descerializado
	 */
	...
	public String serializarActividad(Actividad actividad) {
		String identif="";
		...
		String xml ="<?xml version=\"1.0\"?><WS>"
				+ "<Actividad>"
				+ "<id>"+ identif +"</id>"
				+ "<nombre>"+ actividad.getNombre() + "</nombre>"
	...
	public String serializarActividadIndividual(long idActividad, String nombre, String fechaInicio, String fechaFin) {
		//String xmlFinal = serializarActividad(idActividad, nombre, fechaInicio, fechaFin);
