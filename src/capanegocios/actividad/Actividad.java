...
public class Actividad {
	...
	public String serializar () {
		...
		String xml ="<?xml version=\"1.0\"?><WS>"
		 		+ "<Actividad>"
					+ "<id>"+ identif +"</id>"
					+ "<idAmbitoSuperior>"+ idAmbitoSuperiorString +"</idAmbitoSuperior>"
					+ "<idActividadSuperior>"+ idActividadSuperiorString +"</idActividadSuperior>"
	...
	/* Con el estado interno actual que tiene la instancia , la serializa y manda su xml a integracion, integracion devuelve
	 * un xml con los datos completos de los campos vacios enviados
	 */
	public String getXml(long id) {
		// "No implementado todavia :)";
		// devuelve siempre lo mismo
		String xmlDevuelto ="<?xml version=\"1.0\"?><WS>"
		 		+ "<Actividad>"
					+ "<id>"+ 45 +"</id>"
					...
					+ "<fechaini>"+ "esto es una fechaInicio" +"</fechaini>"
					+ "<fechafin>"+ "esto es una fechaFin" +"</fechafin>"
				+ "</Actividad></WS>";
		 return xmlDevuelto;
	}
	/*
	 * metodo para realizar una consulta a integracion que dependa no solamente del id de la
	 * actividad sino del estado interno de la actividad
	 */
	...
	//FALTA HACER
	// devuelve xml 
	/*public String getActividades(int id,String tipoAmbito){
